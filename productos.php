                    ...
                    <?php if (!empty($products)): ?>
                        <?php foreach ($products as $product): ?>
                            ...
                            <div class="product-card" data-product-id="<?php echo $product['id']; ?>">
                                ...
                                echo "<!-- DEBUG Producto ID: " . $product['id'] . " | Name: " . htmlspecialchars($product['name'] ?? 'NO NAME') . " | primary_image: " . ($product['primary_image'] ?? 'NULL') . " | image_url: " . ($product['image_url'] ?? 'NULL') . " -->\n";
                                
                                // Si existe primary_image (de product_images), usarla directamente
                                if (!empty($product['primary_image'])) {
                                    $image_filename = $product['primary_image'];
                                    echo "<!-- Usando primary_image: " . htmlspecialchars($image_filename) . " -->\n";
                                } else {
                                    // Fallback a image_url de la tabla products o imagen por defecto
