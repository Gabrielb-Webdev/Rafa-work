...
<table border="1">
    <thead>
        ...
        <tr class="instructions">
            ...
            <td style="width: 150px;">OBLIGATORIO<br/>Condición física<br/>Opciones: nuevo, usado, refurbished</td>
            <td style="width: 150px;">OBLIGATORIO<br/>Estado de venta<br/>Opciones: activo, inactivo, agotado</td>
