...
$csv_content = [
    // FILA 1: Encabezados
    ['titulo', 'sku', 'descripcion', 'descripcion_corta', 'precio_pesos', 'precio_dolares', 'stock', 'categoria', 'marca', 'consola', 'generos', 'destacado', 'novedad', 'activo', 'condicion', 'etiquetas', 'meta_titulo', 'meta_descripcion', 'imagen_principal'],
    ...
    [
        ...
        'OPCIONAL - nuevo/usado/reacondicionado',
